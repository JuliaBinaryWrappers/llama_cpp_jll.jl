# Autogenerated wrapper script for llama_cpp_jll for x86_64-apple-darwin
...
JLLWrappers.@declare_library_product(libggml_base, "@rpath/libggml-base.dylib")
JLLWrappers.@declare_library_product(libggml_cpu, "@rpath/libggml-cpu.dylib")
JLLWrappers.@declare_library_product(libllama, "@rpath/libllama.dylib")
JLLWrappers.@declare_library_product(libllava_shared, "@rpath/libllava_shared.dylib")
